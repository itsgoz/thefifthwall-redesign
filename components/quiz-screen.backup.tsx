...
interface QuizQuestion {
  ...
  current: number;
  questionText: string;
  mediaLabel: string; // placeholder label for image/gif/video
  options: Option[];
...
// ─── DEMO DATA ────────────────────────────────────────────────────────────────
const DEMO: QuizQuestion = {
  topic: "Camera Angles",
  total: 10,
  current: 1,
  questionText: "What is a high angle shot?",
  mediaLabel: "Media: image, gif or video",
  options: [
    { key: "A", text: "Level with the subjects" },
    { key: "B", text: "Shot from below looking up" },
    { key: "C", text: "From above only" },
    { key: "D", text: "Shot from above looking down at subject" },
  ],
  correctKey: "D",
  explanation:
    "High angle shots film from above looking down at the subject, making them appear smaller, vulnerable, weak, or overwhelmed. This creates a sense of power dynamics where the viewer feels dominant over the subject.",
};
          ...
          <div style={s.screenPanel}>
            ...
            <div style={s.header}>
              <div style={s.headerLeft}>
                ...
                <span style={s.topicText}>{q.topic}</span>
              </div>
              <div style={s.headerCenter}>
                {Array.from({ length: q.total }, (_, i) => (
                  <div
                    ...
                    style={{
                      ...s.dot,
                      background: i < q.current ? "#C9A84C" : "rgba(201,168,76,0.25)",
                    }}
                  />
                ))}
